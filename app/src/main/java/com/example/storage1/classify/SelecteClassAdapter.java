...
public class SelecteClassAdapter extends TreeListViewAdapter {
    ...
    public SelecteClassAdapter(ListView listView, Context context, List<Node> datas, int defaultExpandLevel, int iconExpand, int iconNoExpand) {
    ...
    public View getConvertView(final Node node, final int position, View convertView, ViewGroup parent) {
        final  SelecteClassAdapter.ViewHolder holder;
        if (convertView == null) {
            convertView = View.inflate(mContext, R.layout.item_select2, null);
            holder = new SelecteClassAdapter.ViewHolder(convertView);
            convertView.setTag(holder);
        } else {
            holder = (SelecteClassAdapter.ViewHolder) convertView.getTag();
        }
    ...
    static class ViewHolder {
        ...
        public ViewHolder(View convertView) {
            checkBox = convertView.findViewById(R.id.cb4);
            tvName = convertView.findViewById(R.id.tv_name4);
            ivExpand = convertView.findViewById(R.id.iv_expand4);
        }
    }
}
